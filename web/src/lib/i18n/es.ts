export const es = {
	...
	auth: {
		...
		verifyEmailTitle: 'Verificá tu email',
		verifyEmailMessage: 'Te enviamos un email de verificación a {email}. Hacé clic en el enlace para activar tu cuenta.',
		verifyEmailCheck: 'Revisá tu bandeja de entrada y spam.',
		resendVerification: 'Reenviar email de verificación',
		resendSuccess: '¡Email de verificación reenviado!',
		emailNotVerified: 'Tu email no está verificado. Revisá tu bandeja de entrada.',
		verifySuccess: '¡Email verificado correctamente! Ya podés iniciar sesión.',
		verifyExpired: 'El enlace de verificación expiró. Reenviá uno nuevo.',
		verifyError: 'Error al verificar el email. Intentá de nuevo.',
		verifyAlreadyVerified: 'Tu email ya fue verificado. Podés iniciar sesión.',
	...
	notifications: {
		...
		appointmentBookedTitle: 'Turno reservado',
		appointmentBookedBody: 'Tu turno ha sido confirmado: {details}',
		appointmentBookedProTitle: '{name} reservó un turno',
		appointmentBookedProBody: 'Nuevo turno reservado: {details}',
		appointmentCancelledByPatientTitle: '{name} canceló su turno',
		appointmentCancelledByPatientBody: 'Turno cancelado: {details}',
	...
	googleCalendar: {
		...
		subtitle: 'Sincronizá los turnos de Wellvio con tu Google Calendar.',
		connect: 'Conectar Google Calendar',
		connectFailed: 'No pudimos iniciar la conexión con Google Calendar. Probá de nuevo.',
		notConnectedHint: 'Al conectar, cada turno reservado en Wellvio se creará en tu calendario, y se actualizará o eliminará cuando el turno cambie.',
		connectedAs: 'Conectado como',
		yourGoogleAccount: 'tu cuenta de Google',
		connectedHint: 'Los nuevos turnos aparecerán automáticamente en tu Google Calendar. Podés desconectar en cualquier momento.',
		connectedToast: 'Google Calendar conectado.',
		consentDenied: 'Cancelaste el permiso. La integración no se activó.',
		disconnect: 'Desconectar',
		disconnectConfirm: '¿Seguro que querés desconectar Google Calendar? Los próximos turnos dejarán de sincronizarse.',
		disconnected: 'Google Calendar desconectado.',
		disconnectFailed: 'No pudimos desconectar. Probá de nuevo.',
		notConfigured: 'La integración con Google Calendar aún no está activada en este servidor.',
	},
	share: {
		shareLink: 'Compartir Link',
		bookingLink: 'Tu link de reservas',
		copyLink: 'Copiar link',
		linkCopied: '¡Link copiado!',
		moreOptions: 'Más opciones...',
		bookMessage: '¡Reservá un turno conmigo!',
		bookTitle: 'Reservar turno',
	},
	publicBooking: {
		booking: 'Reservar Turno',
		bookWith: 'Reservar con',
		selectTimeSlot: 'Seleccioná una fecha y horario para reservar un turno',
		notFound: 'Profesional no encontrado',
		notFoundDesc: 'Este link de reserva puede ser inválido o haber expirado.',
		...
		notesPlaceholder: 'Algo que quieras mencionar...',
		nameEmailRequired: 'El nombre y el email son obligatorios',
		confirmBooking: 'Confirmar Turno',
		bookingFailed: 'Error al reservar. Intentá de nuevo.',
		confirmed: '¡Turno Confirmado!',
		confirmedDesc: 'Tu turno fue reservado exitosamente. El profesional será notificado.',
		with: 'con',
	},
	routines: {
		title: 'Rutinas',
